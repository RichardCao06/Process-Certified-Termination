...
- [x] Human Calibration Pass 1 and context-isolated Agent Blind Pass preserved.
- [x] Human–Agent comparison and Calibration adjudication completed.
- [x] Codebook and Schema v0.2 produced; semantic regression passed 12/12.
